...
def triage_question(question, context_text, recent=""):
    ...
    sys_rules = (
        ...
        "- Choose NONE whenever the passages don't contain the ACTUAL steps/screens/buttons for the "
        "specific thing asked — even if the general topic (rent, tenants, enquiries) is mentioned. A "
        "related topic is NOT a documented procedure. If there is no documented way to do the exact "
        "thing (e.g. no steps for 'add a rent receipt'), choose NONE — never invent one.\n"
