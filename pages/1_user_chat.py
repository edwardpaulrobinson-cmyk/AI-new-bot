...
def build_clients():
    ...
    for _gname, _gkey in _gemini_keys:
        clients[_gname] = {"client": genai.Client(api_key=_gkey, http_options=types.HttpOptions(timeout=60000)), "model": GEMINI_MODEL, "kind": "gemini"}
...
def triage_question(question, context_text, recent=""):
    ...
    sys_rules = (
        ...
        "   Name ONLY the options or situations that actually appear in the passages.\n"
